...
class Book118 extends CI_Controller {
	...
	{
		echo 'Welcome';
		$url = 'http://www.book118.com/sheke/shehui/81754.html';
		$this->temp_book118($url);
	...
	public function run(){
         ...
         $query_urls = $this->db->query( "select url from urls where site_name = 'book118' and status = 0  limit 1000 " );
